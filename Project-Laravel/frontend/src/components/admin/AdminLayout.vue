  ...
  <div class="min-h-screen bg-[#F5F0E8]">
    <header class="bg-[#1a2744] text-white px-6 py-3 flex items-center justify-between sticky top-0 z-50">
      ...
      <div class="flex items-center gap-3">
        <span class="text-xs text-white/60">{{ profile?.nama_lengkap || 'Admin' }}</span>
...
const menuItems = [
  ...
  { path: '/dashboard/campaign-approvals', label: 'Approval Campaign', icon: '<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>' },
  ...
  { path: '/dashboard/disbursements', label: 'Pencairan Dana', icon: '<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>' },
