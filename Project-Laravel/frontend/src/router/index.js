...
import PublicMonitoring from '@/views/campaigns/PublicMonitoring.vue'
...
const routes = [
  ...
  { path: '/monitoring/:id', name: 'PublicMonitoring', component: PublicMonitoring },
  ...
  { path: '/dashboard/campaigns/:id/internal', name: 'CampaignMonitoring', component: () => import('@/views/campaigns/MonitoringInternalView.vue'), meta: { requiresAuth: true, roles: ['SUPERADMIN', 'KOMUNITAS'] } },
  ...
  // Community routes
  { path: '/community/dashboard', component: () => import('@/views/dashboard/DashboardKomunitas.vue'), meta: { requiresAuth: true, role: 'KOMUNITAS' } },
  ...
  { path: '/communities/grafik-donasi', component: () => import('@/views/community/GrafikDonasi.vue'), meta: { requiresAuth: true, role: 'KOMUNITAS' } },
  { path: '/communities/campaigns/:id/withdrawals/create', component: () => import('@/views/campaigns/FundDisbursement.vue'), meta: { requiresAuth: true, role: 'KOMUNITAS' } },
  { path: '/communities/campaigns/:id/withdrawals', component: () => import('@/views/campaigns/RiwayatPencairanPerCampaign.vue'), meta: { requiresAuth: true, role: 'KOMUNITAS' } },
  { path: '/communities/pencairan', component: () => import('@/views/campaigns/PencairanCampaignList.vue'), meta: { requiresAuth: true, role: 'KOMUNITAS' } },
  ...
  { path: '/dashboard/campaigns/:id', name: 'CampaignReview', component: () => import('@/views/campaigns/CampaignDetailView.vue'), meta: { requiresAuth: true, role: 'SUPERADMIN' } },
