...
Route::get('/campaigns/{id}/public-monitoring', [MonitoringController::class, 'publicCampaign']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/communities/campaigns/{id}/withdrawals', [KomunitasCampaignController::class, 'pencairanPerCampaign']);
    Route::post('/communities/campaigns/withdrawals', [KomunitasCampaignController::class, 'ajukanPencairan']);
    ...
    Route::get('/communities/donations/statistics', [DashboardController::class, 'donationStatistics']);
    Route::get('/communities/donations/chart', [DashboardController::class, 'donationChart']);
