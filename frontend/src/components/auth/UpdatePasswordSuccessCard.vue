  ...
  >
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="update-password-success-title"
      >
        <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#F5E6D3]">
          <Check :size="24" class="text-[#8B4513]" />
        </div>

        <h2 id="update-password-success-title" class="mb-1 text-xl font-bold text-[#1a2744]">
          Update Password Berhasil
        </h2>
        <p class="mb-6 text-sm text-[#6B7280]">Selamat datang kembali!</p>
