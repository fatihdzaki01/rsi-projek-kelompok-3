    ...
    <main class="flex-1 py-8">
      <div class="max-w-3xl mx-auto px-6">
        ...
        <nav class="text-sm text-gray-500 mb-4 flex items-center gap-1">
          ...
          <span>/</span>
          <router-link to="/communities" class="hover:text-[#8B4513] transition-colors">Komunitas</router-link>
          <span>/</span>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-stone-100 overflow-hidden mb-6">
            ...
            <div class="px-6 py-5 space-y-4">
              ...
              <div class="flex items-center gap-3 pt-2">
                ...
                <router-link to="/communities" class="px-5 py-2 text-sm text-gray-500 hover:text-gray-700 transition-colors">Batal</router-link>
              </div>
            </div>
          </div>
        </template>
