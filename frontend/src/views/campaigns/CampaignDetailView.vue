        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-stone-100 p-5 space-y-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
              ...
              <div><span class="text-xs text-gray-400 block">Target Penerima</span><span class="text-gray-800 font-medium">{{ campaign.tipe_distribusi === 'kolektif' ? 'Kolektif' : (campaign.total_penerima_manfaat || '-') }}</span></div>
              <div><span class="text-xs text-gray-400 block">Pencairan</span><span class="text-gray-800 font-medium">{{ campaign.jumlah_pencairan_approve || 0 }}x</span></div>
            </div>
